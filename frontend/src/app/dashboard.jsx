    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <div className="w-full h-auto p-6 flex flex-col gap-2 shadow-lg rounded-xl bg-gradient-to-r from-green-400 to-green-600 text-white">
          ...
          <div className="w-full h-auto flex items-center justify-center gap-5">
            ...
            <div className="w-1/3 rounded-xl flex p-5 shadow-md border ">
                <div className="w-full flex flex-col gap-2">
                  <h1 className="text-neutral-800 flex justify-between">Students </h1>
